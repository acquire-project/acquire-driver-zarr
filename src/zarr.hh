...
struct Zarr final : StorageInterface
{
  ...
  private:
    ...
    using CompressionProps =
      StorageProperties::storage_properties_compression_s;
    using CompressionMeta =
      StoragePropertyMetadata::storage_property_metadata_compression_s;
    ...
    void set_compressor(const CompressionProps& props,
